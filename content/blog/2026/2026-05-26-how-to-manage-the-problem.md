+++
title = 'How to Manage: Understanding the problem'
date = 2026-05-25T10:00:00z
draft = false
[taxonomies]
tags = [ "how-to-manage", "problem", "product" ]
[extra]
header = "/assets/how-to-manage-the-problem/area.png"
+++

This is the first post about [how-to-manage series](https://patrickelectric.work/tags/how-to-manage/), a future collection that hopefully will help managers in different areas. This one in particular is the base for decision making to truly understand the problem (and the problem of understanding the problem). Highly based on _Microfoundations Of Strategic Problem Formulation by Markus Baer, Kurt T. Dirks, and Jackson A. Nickerson_.

<!-- more -->

# Before dealing with the problem

Ok, you have a _problem_, that can also be an opportunity or a crisis, something that you need to deal with or needs to be solved. The first thing that you need to do is to formulate it (or characterize), put some time and think carefully about it. The important point is: how you approach and solve the problem will be determined by how you formulate it[^pff].
...
{% quote(source="[In Research, the Problem Is the Problem - Robert W. Lucky](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=5910443)") %}
...
The following is proposed by _Microfoundations Of Strategic Problem Formulation by Markus Baer, Kurt T. Dirks, and Jackson A. Nickerson_ (in my vision at least), the problem formulation should be done in two phases, _framing_ and _formulation_:
...
[^bounded]: [Bounded Rationality](https://en.wikipedia.org/wiki/Bounded_rationality)
[^seven]: [The Magical Number Seven, Plus or Minus Two: Some Limits on Our Capacity for Processing Information](https://en.wikipedia.org/wiki/The_Magical_Number_Seven,_Plus_or_Minus_Two)
[^roger]: Managing the problem formulation process: guidelines for team leaders and facilitators - Roger J. Volkema
[^microformulation]: Microfoundations Of Strategic Problem Formulation - Markus Baer, Kurt T. Dirks, and Jackson A. Nickerson
[^complex]: Challenging Strategic Planning Assumptions - Richard O. Mason and Ian I. Mitroff
[^bias]: [Selection bias](https://en.wikipedia.org/wiki/Selection_bias)
[^deseco]: Definition and Selection of Competencies: Theoretical and Conceptual Foundations
[^groupthink]: Devil’s Advocacy and Dialectical Inquiry: Antidotes to Groupthink - Fred C. Lunenburg
[^groupdecision]: [Group Decision Making - Tim Barnett](https://www.referenceforbusiness.com/management/Gr-Int/Group-Decision-Making.html)
[^devil]: Group Approaches for Improving Strategic Decision Making: A Comparative Analysis of Dialectical Inquiry, Devil's Advocacy, and Consensus - David M. Schweiger, William R. Sandberg and James W. Ragan
[^devil2]: The Utilization Of Individual Capabilities In Making Group Approaches To Strategic Decision - David M. Schweiger And William R. Sandberg
[^safety]: Transformational Leadership And Creative Problem-Solving: The Mediating Role Of Psychological Safety And Reﬂexivity - Abraham C., Zachary S., Galy B., Roni R. and Tali S.
[^gabe]: [Why Gabe Newell Quit Making Games (It’s Weirder Than You Think) - Fred](https://www.twoaveragegamers.com/gabe-newell-stopped-making-games/)
[^divergent]: [Gartner Predicts 20% of Sales Organizations in Fortune 500 Companies Will Actively Recruit Neurodivergent Talent to Improve Business Performance by 2027](https://www.gartner.com/en/newsroom/press-releases/2024-02-29-gartner-predicts-20-percent-of-sales-organizationsi-in-fortune-500-companies-will-actively-recruit-neurodivergent-talent-to-improve-business-performance-by-2027)
[^divergent2]: [Ai Takes Away Jobs | Which Jobs Are Safe in Ai World? Palantir CEO Alex Karp on Autism, Dyslexia](https://www.youtube.com/watch?v=V5ouNJMIIcs)
<!-- Need to read:
    ...
    Cultural Intelligence in Global Teams; A Fusion Model Of Collaboration - Maddy Janssens and Jeanne M. Brett
